...
const OriflameIframe = () => {
  return (
    <div className="w-full h-[1835px] overflow-hidden rounded-xl shadow-2xl border border-gray-200 bg-white relative">
      ...
      */}
      <div className="w-full h-[1885px] pt-14 overflow-hidden bg-white relative">
        <iframe
